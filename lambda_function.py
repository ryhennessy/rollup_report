...
def build_spreadsheet(all_reports):
    ...
    header = xlwt.easyxf('font: bold true;' 'align: horizontal center;' 'pattern: pattern solid, fore_colour gray25;')
    ...
    for acc in all_reports:
       ...
       ws[reportname].write(0,0, reporttitle)
       ...
       for rec in acc['recommendations']:
          ...
          titlelink = 'HYPERLINK("{}", "{}")'.format(rec['INFO_LINK'], rec['TITLE'].replace('"', ""))
